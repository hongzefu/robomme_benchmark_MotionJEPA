# PickXtimes 逐 episode 动作参数

共 100 条（test 50 + val 50，每条标出来源）。数据来源：val 来自原版 h5 `/data/hongzefu/data-0306/record_dataset_PickXtimes.h5`；test 本机无官方 h5，由本轮按 test metadata 死 seed 实跑生成。
...
#### test-ep0 — seed `510000`，难度 easy，动作 3 次
...
#### test-ep1 — seed `510100`，难度 easy，动作 1 次
...
#### test-ep2 — seed `510200`，难度 medium，动作 1 次
...
#### test-ep3 — seed `510300`，难度 hard，动作 4 次
...
#### test-ep4 — seed `510400`，难度 easy，动作 2 次
...
#### test-ep5 — seed `510500`，难度 easy，动作 2 次
...
#### test-ep6 — seed `510600`，难度 medium，动作 1 次
...
#### test-ep7 — seed `510700`，难度 hard，动作 5 次
...
#### test-ep8 — seed `510800`，难度 easy，动作 2 次
...
#### test-ep9 — seed `510900`，难度 easy，动作 2 次
...
#### test-ep10 — seed `511000`，难度 medium，动作 1 次
...
#### test-ep11 — seed `511100`，难度 hard，动作 5 次
...
#### test-ep12 — seed `511200`，难度 easy，动作 3 次
...
#### test-ep13 — seed `511300`，难度 easy，动作 1 次
...
#### test-ep14 — seed `511400`，难度 medium，动作 1 次
...
#### test-ep15 — seed `511501`，难度 hard，动作 4 次
...
#### test-ep16 — seed `511600`，难度 easy，动作 1 次
...
#### test-ep17 — seed `511700`，难度 easy，动作 3 次
...
#### test-ep18 — seed `511800`，难度 medium，动作 2 次
...
#### test-ep19 — seed `511900`，难度 hard，动作 5 次
...
#### test-ep20 — seed `512000`，难度 easy，动作 2 次
...
#### test-ep21 — seed `512100`，难度 easy，动作 1 次
...
#### test-ep22 — seed `512200`，难度 medium，动作 3 次
...
#### test-ep23 — seed `512300`，难度 hard，动作 5 次
...
#### test-ep24 — seed `512400`，难度 easy，动作 3 次
...
#### test-ep25 — seed `512500`，难度 easy，动作 2 次
...
#### test-ep26 — seed `512600`，难度 medium，动作 3 次
...
#### test-ep27 — seed `512700`，难度 hard，动作 4 次
...
#### test-ep28 — seed `512800`，难度 easy，动作 2 次
...
#### test-ep29 — seed `512900`，难度 easy，动作 1 次
...
#### test-ep30 — seed `513000`，难度 medium，动作 1 次
...
#### test-ep31 — seed `513100`，难度 hard，动作 4 次
...
#### test-ep32 — seed `513200`，难度 easy，动作 3 次
...
#### test-ep33 — seed `513300`，难度 easy，动作 1 次
...
#### test-ep34 — seed `513400`，难度 medium，动作 1 次
...
#### test-ep35 — seed `513500`，难度 hard，动作 4 次
...
#### test-ep36 — seed `513600`，难度 easy，动作 1 次
...
#### test-ep37 — seed `513700`，难度 easy，动作 3 次
...
#### test-ep38 — seed `513800`，难度 medium，动作 3 次
...
#### test-ep39 — seed `513900`，难度 hard，动作 4 次
...
#### test-ep40 — seed `514000`，难度 easy，动作 3 次
...
#### test-ep41 — seed `514100`，难度 easy，动作 1 次
...
#### test-ep42 — seed `514200`，难度 medium，动作 2 次
...
#### test-ep43 — seed `514300`，难度 hard，动作 5 次
...
#### test-ep44 — seed `514400`，难度 easy，动作 2 次
...
#### test-ep45 — seed `514500`，难度 easy，动作 1 次
...
#### test-ep46 — seed `514600`，难度 medium，动作 3 次
...
#### test-ep47 — seed `514700`，难度 hard，动作 5 次
...
#### test-ep48 — seed `514800`，难度 easy，动作 3 次
...
#### test-ep49 — seed `514900`，难度 easy，动作 1 次
...
#### val-ep0 — seed `1010000`，难度 easy，动作 3 次
...
#### val-ep1 — seed `1010100`，难度 easy，动作 1 次
...
#### val-ep2 — seed `1010200`，难度 medium，动作 3 次
...
#### val-ep3 — seed `1010300`，难度 hard，动作 4 次
...
#### val-ep4 — seed `1010400`，难度 easy，动作 2 次
...
#### val-ep5 — seed `1010501`，难度 easy，动作 1 次
...
#### val-ep6 — seed `1010600`，难度 medium，动作 3 次
...
#### val-ep7 — seed `1010700`，难度 hard，动作 4 次
...
#### val-ep8 — seed `1010800`，难度 easy，动作 3 次
...
#### val-ep9 — seed `1010900`，难度 easy，动作 2 次
...
#### val-ep10 — seed `1011000`，难度 medium，动作 2 次
...
#### val-ep11 — seed `1011100`，难度 hard，动作 4 次
...
#### val-ep12 — seed `1011200`，难度 easy，动作 2 次
...
#### val-ep13 — seed `1011300`，难度 easy，动作 1 次
...
#### val-ep14 — seed `1011400`，难度 medium，动作 2 次
...
#### val-ep15 — seed `1011500`，难度 hard，动作 5 次
...
#### val-ep16 — seed `1011600`，难度 easy，动作 3 次
...
#### val-ep17 — seed `1011700`，难度 easy，动作 2 次
...
#### val-ep18 — seed `1011800`，难度 medium，动作 2 次
...
#### val-ep19 — seed `1011900`，难度 hard，动作 4 次
...
#### val-ep20 — seed `1012000`，难度 easy，动作 3 次
...
#### val-ep21 — seed `1012100`，难度 easy，动作 3 次
...
#### val-ep22 — seed `1012200`，难度 medium，动作 3 次
...
#### val-ep23 — seed `1012300`，难度 hard，动作 5 次
...
#### val-ep24 — seed `1012400`，难度 easy，动作 1 次
...
#### val-ep25 — seed `1012500`，难度 easy，动作 3 次
...
#### val-ep26 — seed `1012600`，难度 medium，动作 3 次
...
#### val-ep27 — seed `1012700`，难度 hard，动作 5 次
...
#### val-ep28 — seed `1012800`，难度 easy，动作 3 次
...
#### val-ep29 — seed `1012900`，难度 easy，动作 2 次
...
#### val-ep30 — seed `1013000`，难度 medium，动作 1 次
...
#### val-ep31 — seed `1013100`，难度 hard，动作 5 次
...
#### val-ep32 — seed `1013200`，难度 easy，动作 1 次
...
#### val-ep33 — seed `1013300`，难度 easy，动作 1 次
...
#### val-ep34 — seed `1013400`，难度 medium，动作 2 次
...
#### val-ep35 — seed `1013500`，难度 hard，动作 5 次
...
#### val-ep36 — seed `1013600`，难度 easy，动作 3 次
...
#### val-ep37 — seed `1013700`，难度 easy，动作 2 次
...
#### val-ep38 — seed `1013800`，难度 medium，动作 2 次
...
#### val-ep39 — seed `1013900`，难度 hard，动作 5 次
...
#### val-ep40 — seed `1014000`，难度 easy，动作 2 次
...
#### val-ep41 — seed `1014100`，难度 easy，动作 3 次
...
#### val-ep42 — seed `1014200`，难度 medium，动作 2 次
...
#### val-ep43 — seed `1014300`，难度 hard，动作 4 次
...
#### val-ep44 — seed `1014400`，难度 easy，动作 2 次
...
#### val-ep45 — seed `1014500`，难度 easy，动作 1 次
...
#### val-ep46 — seed `1014600`，难度 medium，动作 1 次
...
#### val-ep47 — seed `1014700`，难度 hard，动作 4 次
...
#### val-ep48 — seed `1014800`，难度 easy，动作 1 次
...
#### val-ep49 — seed `1014900`，难度 easy，动作 2 次
