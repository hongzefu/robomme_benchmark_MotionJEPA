...
跑前分布还有一套更细的 2D 图（初始位置叠加、随机事件箭头、逐条记录卡、采样机制图，共 67 张），见 [injection-before-2d/NEW_VALUE_DISTRIBUTION_BEFORE.md](injection-before-2d/NEW_VALUE_DISTRIBUTION_BEFORE.md)。
