...
def _args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="对已存在的产物做只读复核，并把最新的完整报告写到 scripts/data-generation-v2.1/reports/ 下的 generation_report.json 与 generation_report.md")
