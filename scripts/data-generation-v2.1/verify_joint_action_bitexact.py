...
- ``episode_<i>/setup/masked_rgb_*``（schema_version / paint_color / black_luminance_max /
  painted / kept / black_exempt）
...
# 纯色棕遮蔽图（masked-rgb-v2）：`/masked_rgb_` 一条覆盖 setup 下的 schema_version /
# paint_color / black_luminance_max / painted / kept / black_exempt 六处
