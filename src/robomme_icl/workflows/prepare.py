...
from .workers import run_episode_process, retry_same_spec, new_manager, gpu_limits, run_jobs
    ...
    for candidate_index in range(limit):
        ...
        try:
            ...
            if rejection_path.exists():
                ...
                continue
            geometry_report = {"scope": "initial_layout", "source": "native_collision_shapes"}
            paths = []
            for repeat in range(2):
                ...
                def run(candidate: Any) -> Path:
                    ...
                    with job["gpu_limit"]:
                        ...
                        return run_episode_process(candidate, path, timeout_seconds=job["timeout_seconds"], render_gpu=render_gpu)
            ...
            geometry_report = next(frame["info"]["geometry_report"] for frame in left.frames
