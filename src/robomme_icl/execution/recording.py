...
class RecordingEnv(gym.Wrapper):
    ...
    def _record(self, raw, native_info, action, operation, **details):
        ...
        frame = {"observation": normalized_observation(raw, base),
                 "joint_action": None if action is None else array_copy(action), "info": info}
    ...
    def evaluate(self, solve_complete_eval=False):
        ...
        self._record(self.unwrapped.get_obs(), result, None, "evaluate",
