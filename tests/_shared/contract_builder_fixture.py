"""测试专用的 v1/v2/v3 纯构建器；没有写文件和 CLI 分支。"""
...
from scripts.injection.candidates.contract import (
    CONSTS,
...
def build_v1(sampling: dict[str, Any], sampling_path: Path) -> dict[str, Any]:
    from scripts.injection.candidates.specs import operand_sha256  # 惰性：避免 contract ↔ specs 循环
